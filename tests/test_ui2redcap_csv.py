...
def test_audio_csv():
    ...
    expected_output = [
        ...
        {'record_id': '99999', 'redcap_repeat_instrument': 'Recording', 'redcap_repeat_instance': 2, 'recording_id': '69181d90-aae4-49d0-861d-4ff4a939bff0', 'recording_acoustic_task_id': 'long_sounds_task-2', 'recording_session_id': '14829893-3879-4723-932b-d98d6bc356a8-', 
            'recording_name': '69181d90-aae4-49d0-861d-4ff4a939bff0.wav', 'recording_duration': 2.389333, 'recording_size': 458796, 'recording_profile_name': 'Speech', 'recording_profile_version': 'v1.0.0', 'recording_input_gain': 0.0, 'recording_microphone': 'ipad'}]
