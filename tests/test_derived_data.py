...
def test_spectrogram_generator_basic(temp_dir):
...
def test_spectrogram_generator_sorting(temp_dir):
...
def test_spectrogram_generator_log_processing(temp_dir):
...
def test_load_audio_features_basic(temp_dir):
...
def test_load_audio_features_missing_metadata(temp_dir):
...
def test_feature_extraction_generator_spectrogram(temp_dir):
...
def test_feature_extraction_generator_mfcc(temp_dir):
...
def test_feature_extraction_generator_invalid_feature():
...
def test_drop_columns_nonexistent():
...
def test_drop_columns_partial_match():
...
def test_clean_phenotype_data_alcohol_fix():
...
def test_clean_phenotype_data_column_removal():
...
def test_add_record_id_when_missing():
...
def test_add_record_id_when_present():
...
def test_rename_record_id_basic():
    ...
    assert "participant_id" in result_phenotype  
    assert "other_col" in result_phenotype

def test_rename_record_id_no_record_id_column():
...
def test_add_sex_at_birth_basic():
...
def test_add_sex_at_birth_no_gender_columns():
...
def test_load_phenotype_data_basic(temp_dir):
...
def test_load_phenotype_data_with_extension(temp_dir):
...
def test_load_phenotype_data_participant_removal(temp_dir):
...
def test_load_phenotype_data_hierarchical_phenotype(temp_dir):
...
def test_load_phenotype_data_missing_files(temp_dir):
...
def test_load_phenotype_data_column_count_mismatch(temp_dir):
