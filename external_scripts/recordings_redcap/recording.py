...
acoustic_names_mapping = { # skim over the acoustic tasks.....
    ...
    "daysAndNumberNaming": "Days and Number naming",
...
recording_names_mapping = {
    ...
    "daysAndNumberNaming1": "Days and Number naming-numbers",
    ...
    "conversation(10+)1": "Conversation (6 plus)-favorite_food",
    "conversation(10+)2": "Conversation (6 plus)-favorite_show_movie_game",
    "conversation(10+)3": "Conversation (6 plus)-outside_of_school",
    "conversation(10+)4": "Conversation (6 plus)-ready_for_school",
...
def create_recording_redcap(recording_csv, output_csv):
    ...
    def acoustic_naming_fix(df):
        mapping = {"conversation(10+)": "Conversation (6 plus)",
