...
@click.option("--standardize_audios/--no-standardize_audios", type=bool, default=False, show_default=True)
def redcap2bids(
    filename,
    outdir,
    audiodir,
    ...
    Args:
        ...
        standardize_audios (bool, optional): Standardize the audio to 16KHz, mono-channel. Default False.
