...
def redcap_to_bids(
    ...
    This function is now a wrapper around the new RedCapDataset and BIDSDataset classes for backward compatibility.
    ...
    _LOGGER.info("Using RedCapDataset and BIDSDataset classes for BIDS conversion (legacy wrapper)")
    redcap_dataset = RedCapDataset.from_redcap(filename)
    bids_dataset = BIDSDataset.from_redcap(redcap_dataset, outdir=outdir, audiodir=audiodir)
    return bids_dataset
